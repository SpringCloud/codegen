    ...
    <div class="SW_footer">
      <div class="ft layout clearfix hidden-xs">
        ...
        <div class="ft_item">
          <h4 class="a3">友情链接</h4>
          <ul>
            <li><a href="" target="_blank">社区支持</a></li>
            <li><a href="http://www.itdks.com/" target="_blank">IT大咖说</a></li>
          </ul>
        </div>
        <div class="ft_item">
          <h4 class="a4">常用链接</h4>
...
<style scoped>
  ...
  .ft h4 {
    ...
    text-indent: -9999px;
    margin-bottom: 10px;
    /*background: url(../../assets/sw-footer-sprite.png) no-repeat;*/
  }
